(() => {
    ...
    (() => {
        ...
        function initSliders() {
            ...
            if (document.querySelector(".trends-page__slider")) new swiper_core_Swiper(".trends-page__slider", {
                modules: [ Navigation, Autoplay ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
            ...
            if (document.querySelector(".catalog-page__slider")) new swiper_core_Swiper(".catalog-page__slider", {
                ...
                speed: 800,
                pagination: {
                    el: ".control-slider-catalog__swiper-pagination",
                    clickable: true,
                ...
                navigation: {
                    prevEl: ".control-slider-catalog__swiper-button-prev",
                    nextEl: ".control-slider-catalog__swiper-button-next"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1,
        ...
        const script_button = document.querySelector(".header-switch__input");
